    ...
    <div className="contact">
      ...
      <section class="text">
        <p class="first-paragraph">
          ...
          Instead of a series of coding challenges, ll learn through
        ...
        <p>
          It as dramatic arevelation in Back to the Future. It just occurred to
          me while I was going for a run. The revelation: the entire curriculum
          should be a series of projects. Instead of individual coding
          challenges,  just have projects, each with their own seamless
          series of tests. Each test gives you just enough information to figure
        ...
        <p>
          ...
          projects. And  plenty of repetition to help you retain
        ...
        <p>
          ...
          get that sense of forward progress right from
